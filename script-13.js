...
window.checkDevAndPremiumUI = function() {
    ...
    if (devAppBtn) {
        ...
        // If this fires, '#devControlsBtn' doesn't exist in the DOM yet (or the id
        // in the HTML doesn't match) — the isDev flag can be perfectly correct and
        // the button will still never appear. Check the actual id on the dock button.
        console.warn("checkDevAndPremiumUI: no element with id 'devControlsBtn' found — dev controls button can't be shown/hidden.");
    }
};
...
async function exportSave() {
    ...
    try {
        // Cloud Save and Export intentionally call the same serializer. This
        // makes every exported JSON file directly importable as a cloud save.
        const saveData = await window.createLudusBackup(false);
        const blob = new Blob([JSON.stringify(saveData, null, 2)], { type: "application/json" });
        const a = document.createElement("a");
        const url = URL.createObjectURL(blob);
        a.href = url;
        a.download = `ludus_backup_${Date.now()}.json`;
...
const cloudOverwriteKey = "ludus_cloud_overwrite_enabled";
if (localStorage.getItem(cloudOverwriteKey) === null) localStorage.setItem(cloudOverwriteKey, "true");
let allowCloudOverwrite = localStorage.getItem(cloudOverwriteKey) !== "false";
...
if (cloudOverwriteToggle) {
    ...
    cloudOverwriteToggle.addEventListener('change', (e) => {
        ...
        localStorage.setItem(cloudOverwriteKey, allowCloudOverwrite);
    });
}
...
{name:"Milk Inside a Bag of Milk Inside a Bag of Milk", path:"./Versions/Assets/Game Data/650-f.html", logo:"./Versions/Assets/Pictures/Non-edited/650.webp", secret: true},
  ...
  {name:"Youtube",path:"yt-5.html", logo:"Versions/Assets/Pictures/Non-edited/youtube.png", isApp: true, appColor: "#fe0000"},
  ...
  {name:"Territorial.io", path:"./Versions/Assets/Game Data/303.html", logo:"./Versions/Assets/Pictures/Non-edited/303.webp"},
  ...
  {name:"Angry Birds Chrome", path:"./Versions/Assets/Game Data/316.html", logo:"./Versions/Assets/Pictures/Non-edited/316.webp"},
  {name:"sandspiel", path:"./Versions/Assets/Game Data/317.html", logo:"./Versions/Assets/Pictures/Non-edited/317.webp"},
  {name:"Side Effects", path:"./Versions/Assets/Game Data/318.html", logo:"./Versions/Assets/Pictures/Non-edited/318.webp"},
  {name:"Build a Queen", path:"./Versions/Assets/Game Data/319.html", logo:"./Versions/Assets/Pictures/Non-edited/319.webp"},
  {name:"3D Bowling", path:"./Versions/Assets/Game Data/320.html", logo:"./Versions/Assets/Pictures/Non-edited/320.webp"},
  {name:"Sushi Roll", path:"./Versions/Assets/Game Data/322.html", logo:"./Versions/Assets/Pictures/Non-edited/322.webp"},
  {name:"Find the Alien", path:"./Versions/Assets/Game Data/323.html", logo:"./Versions/Assets/Pictures/Non-edited/323.webp"},
  {name:"Kitchen Bazar", path:"./Versions/Assets/Game Data/325.html", logo:"./Versions/Assets/Pictures/Non-edited/325.webp"},
  {name:"Pokey Ball", path:"./Versions/Assets/Game Data/326.html", logo:"./Versions/Assets/Pictures/Non-edited/326.webp"},
  {name:"Slime.io", path:"./Versions/Assets/Game Data/327.html", logo:"./Versions/Assets/Pictures/Non-edited/327.webp"},
  {name:"Om Nom Run", path:"./Versions/Assets/Game Data/328.html", logo:"./Versions/Assets/Pictures/Non-edited/328.webp"},
  ...
  {name:"Fire and Frost Master", path:"./Versions/Assets/Game Data/389.html", logo:"./Versions/Assets/Pictures/Non-edited/389.webp"},
  ...
  {name:"Weapon Scale", path:"./Versions/Assets/Game Data/420.html", logo:"./Versions/Assets/Pictures/Non-edited/420.webp"},
  ...
  {name:"Aquapark.io", path:"./Versions/Assets/Game Data/448.html", logo:"./Versions/Assets/Pictures/Non-edited/448.webp"},
  ...
  {name:"Stick With It", path:"./Versions/Assets/Game Data/502-fixed.html", logo:"./Versions/Assets/Pictures/Non-edited/502.webp"},
  ...
  {name:"SpongeBob SquarePants: Land Ho!", path:"./Versions/Assets/Game Data/526.html", logo:"./Versions/Assets/Pictures/Non-edited/526.webp"},
  {name:"SpongeBob SquarePants: Sandy's Sponge Stacker", path:"./Versions/Assets/Game Data/529.html", logo:"./Versions/Assets/Pictures/Non-edited/529.webp"},
  ...
  {name:"myTeardrop", path:"./Versions/Assets/Game Data/540.html", logo:"./Versions/Assets/Pictures/Non-edited/540.webp"},
  ...
  {name:"Sonic the Hedgehog 3: Angel Island Remastered", path:"./Versions/Assets/Game Data/550.html", logo:"./Versions/Assets/Pictures/Non-edited/550.webp"},
  ...
  {name:"Layers Roll", path:"./Versions/Assets/Game Data/571.html", logo:"./Versions/Assets/Pictures/Non-edited/571.webp"},
  {name:"Lazy Jumper", path:"./Versions/Assets/Game Data/572.html", logo:"./Versions/Assets/Pictures/Non-edited/572.webp"},
  {name:"Man Runner 2048", path:"./Versions/Assets/Game Data/573.html", logo:"./Versions/Assets/Pictures/Non-edited/573.webp"},
  {name:"Pottery Master", path:"./Versions/Assets/Game Data/574.html", logo:"./Versions/Assets/Pictures/Non-edited/574.webp"},
  ...
  {name:"Sonic Mania", path:"./Versions/Assets/Game Data/590-f.html", logo:"./Versions/Assets/Pictures/Non-edited/590.webp"},
  ...
  {name:"Toy Rider", path:"./Versions/Assets/Game Data/614.html", logo:"./Versions/Assets/Pictures/Non-edited/614.webp"},
  ...
  {name:"Tall.io", path:"./Versions/Assets/Game Data/664.html", logo:"./Versions/Assets/Pictures/Non-edited/664.webp"},
  ...
  {name:"Terraria", path:"./Versions/Assets/Game Data/669.html", logo:"./Versions/Assets/Pictures/Non-edited/669.webp"},
  ...
  {name:"Half Life: Opposing Force", path:"./Versions/Assets/Game Data/693.html", logo:"./Versions/Assets/Pictures/Non-edited/693.webp"},
  ...
  {name:"Saihate Station (さいはて駅)", path:"./Versions/Assets/Game Data/737.html", logo:"./Versions/Assets/Pictures/Non-edited/737.webp"},
  ...
  {name:"Minecraft Pocket Edition", path:"./Versions/Assets/Game Data/754.html", logo:"./Versions/Assets/Pictures/Non-edited/754.webp"},
  ...
  {name:"Five Night's at Shrek's Hotel", path:"./Versions/Assets/Game Data/764.html", logo:"./Versions/Assets/Pictures/Non-edited/764.webp"},
  ...
  {name:"Sonic Robo Blast 2", path:"./Versions/Assets/Game Data/770-update.html", logo:"./Versions/Assets/Pictures/Non-edited/770.webp"},
  ...
  {name:"Who's Your Daddy", path:"./Versions/Assets/Game Data/791.html", logo:"./Versions/Assets/Pictures/Non-edited/791.webp"},
...
function switchSection(targetAppId, clickedBtn) {
    ...
    // The code app is developer-only. Keeping this check here also prevents
    // programmatic navigation from bypassing the hidden dock button.
    if (targetAppId === 'app-files' && sessionStorage.getItem('mathmaster_dev_unlocked') !== 'true') {
        console.warn('Developer access is required to open the code app.');
        return;
    }
