...
{name:"Milk Inside a Bag of Milk Inside a Bag of Milk", path:"./Versions/Assets/Game Data/650-f.html", logo:"./Versions/Assets/Pictures/Non-edited/650.webp", secret: true},
  ...
  {name:"Basketball Stars", path:"Versions/Assets/Game Data/Basketball Stars.html", logo:"pics/BasketballStars-n.webp"},
  ...
  {name:"Chrome Dino", path:"Chrome Dino.html", logo:"pics/DinosaurGame-n.webp"},
  {name:"Mario", path:"Mario.html", logo:"pics/Mario-n.webp"},
  {name:"Neon Breakout", path:"Neon Breakout.html", logo:"pics/Breakout-n.webp"},
  {name:"Neon Gambit", path:"Neon Gambit.html", logo:"pics/Chess-n.webp"},
  {name:"Pac-Man", path:"Pac-Man.html", logo:"pics/Pacman-n.webp"},
  {name:"Space Invaders", path:"Space Invaders.html", logo:"pics/SpaceInvaders-n.webp"},
];
// ==============================================
